# Week 14 — Review and Project Demonstrations

| | |
|---|---|
| **Lecture (2 h)** | Course synthesis; examination preparation; the full pipeline revisited end to end |
| **ROS 2 practice (1 h)** | Project finalisation |
| **CLO served** | CLO 3, CLO 4 |
| **Assessment this week** | **Project demonstration + report** |
| **Reading** | see `../../readings/—/` |

## Status

| Artifact | Path | Status |
|---|---|---|
| Lecture deck | `slides/EE414_W14_*.tex` / `.pdf` | ❌ not authored |
| Exercise set + key | `exercises/EE414_W14_exercises.pdf` / `_solutions.pdf` | ❌ not authored |
