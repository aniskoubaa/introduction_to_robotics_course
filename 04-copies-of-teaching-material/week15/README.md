...
| | |
|---|---|
| **Lecture A (1.5 h)** | — no new material — |
| **Lecture B (1.5 h) — ROS 2** | — |
| **CLO served** | CLO 1–4 |
| **Assessment this week** | **Final Examination** (comprehensive) |
...
|---|---|---|
| Lecture deck | `slides/EE414_W15_*.tex` / `.pdf` | ❌ not authored |
| Exercise set + key | `exercises/EE414_W15_exercises.pdf` / `_solutions.pdf` | ❌ not authored |
...
|---|---|---|
| `slides/EE414_W15_....tex` / `.pdf` | 2 h · — slides | — |
