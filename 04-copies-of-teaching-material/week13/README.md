# Week 13 — Robot Ethics, Safety and Professional Practice

| | |
|---|---|
| **Lecture A (1.5 h)** | Safety cases and standards; liability for autonomous action; workforce impact; dual use; open-source licensing and attribution |
| **Lecture B (1.5 h) — ROS 2** | Supervised project work |
| **CLO served** | CLO 4 |
| **Assessment this week** | Project design review |
| **Reading** | see `../../readings/topic08_ethics_and_safety/` |

## Status

| Artifact | Path | Status |
|---|---|---|
| Lecture deck | `slides/EE414_W13_*.tex` / `.pdf` | ❌ not authored |
| Exercise set + key | `exercises/EE414_W13_exercises.pdf` / `_solutions.pdf` | ❌ not authored |
...
|---|---|---|
| `slides/EE414_W13_....tex` / `.pdf` | 2 h · — slides | — |
