# Week 02 — ROS 2 Architecture and the Computation Graph
...
|---|---|---|
| Lecture deck | `slides/EE414_W02_*.tex` / `.pdf` | ❌ not authored |
| Exercise set + key | `exercises/EE414_W02_exercises.pdf` / `_solutions.pdf` | ❌ not authored |
...
|---|---|---|
| `slides/EE414_W02_....tex` / `.pdf` | 2 h · — slides | — |
