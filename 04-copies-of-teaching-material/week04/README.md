...
| | |
|---|---|
| **Lecture (2 h)** | Pose and velocity in the plane; the differential-drive model; wheel odometry and its error sources |
| **ROS 2 practice (1 h)** | Open-loop motion: `/cmd_vel` and `/odom`; straight-line and rotation primitives in Gazebo |
...
|---|---|---|
| Lecture deck | `slides/EE414_W04_*.tex` / `.pdf` | ❌ not authored |
...
|---|---|---|
| `slides/EE414_W04_....tex` / `.pdf` | 2 h · — slides | — |
