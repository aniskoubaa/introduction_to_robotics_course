...
% The light box: for things that are NOT runnable. The contrast is the point.
\newtcblisting{spec}[1][]{
  enhanced, listing only,
  colback=softgrey, colframe=primary!35, boxrule=0.6pt, arc=3pt,
  left=8pt, right=8pt, top=5pt, bottom=5pt,
  listing options={basicstyle=\ttfamily\footnotesize\color{primary!85!black},
                   columns=fullflexible, keepspaces=true}, #1}
