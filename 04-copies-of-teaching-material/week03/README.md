# Week 03 — Communication Models in ROS 2

| | |
|---|---|
| **Lecture A (1.5 h)** | Publish/subscribe vs. request/response vs. goal-oriented interaction; message design and interface definition |
| **Lecture B (1.5 h) — ROS 2** | Topics and custom messages; a service pair; parameters; a first action client |
| **CLO served** | CLO 1, CLO 3 |
| **Assessment this week** | **Assignment 1** |
...
|---|---|---|
| Lecture deck | `slides/EE414_W03_*.tex` / `.pdf` | ❌ not authored |
| Exercise set + key | `exercises/EE414_W03_exercises.pdf` / `_solutions.pdf` | ❌ not authored |
...
|---|---|---|
| `slides/EE414_W03_....tex` / `.pdf` | 2 h · — slides | — |

Build: `pdflatex <file>.tex` twice. Shared preamble at `../shared/ee414-beamer-preamble.tex`.

## Lecture B — the ROS 2 session

**Goal:** Topics and custom messages; a service pair; parameters; a first action client
