...
| | |
|---|---|
| **Lecture (2 h)** | Publish/subscribe vs. request/response vs. goal-oriented interaction; message design and interface definition |
| **ROS 2 practice (1 h)** | Topics and custom messages; a service pair; parameters; a first action client |
