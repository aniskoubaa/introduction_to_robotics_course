...
`EE414_W03_demo.mp4` is the **recorded walkthrough**: 21 min 28 s, 1080p, narrated. It runs
79 of the 81 commands below against a live ROS 2 Jazzy system — turtlesim, TurtleBot 3 in
Gazebo, the editor and the terminals — with each command's plain-English explanation on screen
and spoken as it runs. The narration is the cue sheet's own wording, so the video, the caption
and this folder all say the same thing in the same words. `EE414_W03_demo_chapters.txt` holds
the chapter timestamps. The two `rqt_graph` lines on slides 16 and 34 are **not** in the
recording — they open a GUI window, so they are written for the live demo only. It is
re-recordable, narration included: see `../../shared/video/README.md`.
...
| `EE414_W03_demo.mp4` — recorded walkthrough of 79 of the 81 commands | ⚠️ re-record to cover the two `rqt_graph` lines · made by `../../shared/video/run_demo.py` |
